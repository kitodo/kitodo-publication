...
class LanguageCode
{
     ...
     * @var array
     */
    protected static $languageCodes = array(
    ...
    public static function convertFrom6391to6392T($code)
    {
        foreach(self::$languageCodes as $languageCode) {
            if($languageCode[0] == $code) {
                return $languageCode[1];
            }
        }
    }

    public static function convertFrom6391to6392B($code)
    {
        foreach(self::$languageCodes as $languageCode) {
            if($languageCode[0] == $code) {
    ...
    public static function convertFrom6391to6393($code)
    {
        foreach(self::$languageCodes as $languageCode) {
            if($languageCode[0] == $code) {
                return $languageCode[3];
            }
        }
    }

    public static function convertFrom6392Tto6391($code)
    {
        foreach(self::$languageCodes as $languageCode) {
            if($languageCode[1] == $code) {
                return $languageCode[0];
            }
        }
    }

    public static function convertFrom6392Tto6392B($code)
    {
        foreach(self::$languageCodes as $languageCode) {
            if($languageCode[1] == $code) {
                return $languageCode[2];
    ...
    public static function convertFrom6392Tto6393($code)
    {
        foreach(self::$languageCodes as $languageCode) {
            if($languageCode[1] == $code) {
                return $languageCode[3];
    ...
    public static function convertFrom6392Bto6391($code)
    {
        foreach(self::$languageCodes as $languageCode) {
            if($languageCode[2] == $code) {
                return $languageCode[0];
            }
        }
    }    

    public static function convertFrom6392Bto6392T($code)
    {
        foreach(self::$languageCodes as $languageCode) {
            if($languageCode[2] == $code) {
                return $languageCode[1];
    ...
    public static function convertFrom6392Bto6393($code)
    {
        foreach(self::$languageCodes as $languageCode) {
            if($languageCode[2] == $code) {
                return $languageCode[3];
