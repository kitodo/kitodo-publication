...
<?php
	...
	if (empty($times)) {
		...
		printf(
			'<p>Highlighted %d times in %d seconds with an average of %f seconds per execution using %fMB of memory at peak.</p>',
			count($times), $limit,
