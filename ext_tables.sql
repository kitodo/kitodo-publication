...
#
# Table structure for table 'tx_dpf_domain_model_documents'
#
CREATE TABLE tx_dpf_domain_model_documents (
...
#
# Table structure for table 'tx_dpf_domain_model_documenttransfer'
#
CREATE TABLE tx_dpf_domain_model_documenttransfer (
	...
	http_status varchar(255) DEFAULT '' NOT NULL,
	response varchar(255) DEFAULT '' NOT NULL,
	error int(11) DEFAULT '0' NOT NULL,
	parent_document int(11) unsigned DEFAULT '0',
