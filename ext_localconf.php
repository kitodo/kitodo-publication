...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/install']['update']['dpfFixInstitutionAuthorClassHook'] =
    \EWW\Dpf\Updates\FixInstitutionAuthorClassHookUpdate::class;

$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/install']['update']['dpfHideProjectEnglishTitleRows'] =
    \EWW\Dpf\Updates\HideProjectEnglishTitleRowsUpdate::class;

$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/install']['update']['dpfRenameDoiLabelAndStripAndereAusgabeHeading'] =
    \EWW\Dpf\Updates\RenameDoiLabelAndStripAndereAusgabeHeadingUpdate::class;

$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/install']['update']['dpfStripHerausgabeSuffixFromDocumentType'] =
    \EWW\Dpf\Updates\StripHerausgabeSuffixFromDocumentTypeUpdate::class;

$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/install']['update']['dpfAddNameIdentifierTooltip'] =
    \EWW\Dpf\Updates\AddNameIdentifierTooltipUpdate::class;
...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/install']['update']['dpfAddOtherVersionIdentifierRows'] =
    \EWW\Dpf\Updates\AddOtherVersionIdentifierRowsUpdate::class;
...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/install']['update']['dpfAddPositionalTooltipsToAuthorPublisher'] =
    \EWW\Dpf\Updates\AddPositionalTooltipsToAuthorPublisherUpdate::class;
