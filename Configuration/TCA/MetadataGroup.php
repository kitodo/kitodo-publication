...
$GLOBALS['TCA']['tx_dpf_domain_model_metadatagroup'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, display_name, mandatory, max_iteration, metadata_object',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, display_name, mandatory, max_iteration, metadata_object, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'metadata_object' => array(
			...
			'config' => array(
				...
				'MM' => 'tx_dpf_metadatagroup_metadataobject_mm',
				'size' => 10,
				'autoSizeMax' => 30,
				'maxitems' => 9999,
				'multiple' => 0,
				'wizards' => array(
					...
					'add' => Array(
						...
						'icon' => 'add.gif',
						'params' => array(
							'table' => 'tx_dpf_domain_model_metadataobject',
							'pid' => '###CURRENT_PID###',
							'setValue' => 'prepend'
							),
