...
$GLOBALS['TCA']['tx_dpf_domain_model_metadatagroup'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, display_name, mandatory, mapping, mods_extension_mapping, mods_extension_reference, max_iteration, metadata_object, backend_only, info_text',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, display_name, mandatory, mapping, mods_extension_mapping, mods_extension_reference, max_iteration, metadata_object, backend_only, info_text, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
