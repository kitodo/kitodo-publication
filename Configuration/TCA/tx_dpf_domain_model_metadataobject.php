...
return array(
    ...
    'columns'   => array(
        ...
        'display_doi_link'    => array(
            'displayCond' => 'FIELD:input_field:=:0',
            'exclude'   => 1,
            'l10n_mode' => 'exclude',
            'label'     => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_metadataobject.display_doi_link',
            'config'    => array(
                'type'    => 'check',
                'default' => 0,
            ),
