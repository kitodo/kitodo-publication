	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_dpf_domain_model_formpage',
				'foreign_table_where' => 'AND tx_dpf_domain_model_formpage.pid=###CURRENT_PID### AND tx_dpf_domain_model_formpage.sys_language_uid IN (-1,0)',
			),
		),
		...
		'title' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_formpage.title',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
		...
		'page' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_formpage.page',
			'config' => array(
				'type' => 'input',
				'size' => 4,
				'eval' => 'int'
		...
		'display_title' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_formpage.display_title',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
		...
		'metadata_group' => array(
			...
			'config' => array(
				...
				'MM' => 'tx_dpf_formpage_metadatagroup_mm',
				'size' => 10,
				'autoSizeMax' => 30,
				'maxitems' => 9999,
				'multiple' => 0,
