...
$GLOBALS['TCA']['tx_dpf_domain_model_client'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, client, owner_id, urn_namespace, project',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, client, owner_id, urn_namespace, project, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'client' => array(
			...
			'config' => array(
                ...
                'urn_namespace' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.urn_namespace',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
