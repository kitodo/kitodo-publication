...
return array(
    'ctrl' => array(
        ...
        'searchFields'             => 'client, owner_id, network_initial, library_identifier, admin_email, project,
            ...
            fis_mapping,
            file_xpath, file_id_xpath, file_primary_xpath, file_mimetype_xpath,
            file_href_xpath, file_download_xpath, file_archive_xpath, file_deleted_xpath ,file_title_xpath,
            date_xpath, urn_xpath, primary_urn_xpath, state_xpath, type_xpath, type_xpath_input, namespaces, title_xpath, process_number_xpath,
    ...
    'types'     => array(
        ...
        --div--;Static XML, namespaces, file_xpath,  file_id_xpath, file_primary_xpath, file_mimetype_xpath,
        file_href_xpath, file_download_xpath, file_archive_xpath, file_deleted_xpath ,file_title_xpath,
        --pallette--;;pallette_dateIssued_xpath, urn_xpath, primary_urn_xpath, state_xpath, type_xpath, type_xpath_input, title_xpath, process_number_xpath, submitter_name_xpath, submitter_email_xpath, submitter_notice_xpath,
        original_source_title_xpath, creator_xpath, creation_date_xpath, repository_creation_date_xpath,
        repository_last_mod_date_xpath, deposit_license_xpath, all_notes_xpath, private_notes_xpath,
        person_xpath, person_family_xpath, person_given_xpath, person_role_xpath, person_fis_identifier_xpath, person_affiliation_xpath, person_affiliation_identifier_xpath,
        person_author_role, person_publisher_role,
        ...
        --div--;Search field XML,
            ...
            --pallette--;;pallette_search_language_xpaths,
            --pallette--;;pallette_search_corporation_xpaths,
    ...
    'palettes'  => array(
        ...
        'pallette_project_id_xpath' =>  array(
            'label' => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.search_field_xml.project_id.label',
            'showitem' => 'project_id_xpath'
        ),
        ...
        'pallette_search_language_xpaths' =>  array(
            'label' => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.search_field_xml.search_language.label',
            'showitem' => 'search_language_xpaths'
        ),
        'pallette_search_corporation_xpaths' =>  array(
            'label' => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.search_field_xml.search_corporation.label',
            'showitem' => 'search_corporation_xpaths'
        ),
    ),
    'columns'   => array(
        ...
        'file_primary_xpath' => array(
            'exclude'   => 1,
            'l10n_mode' => 'exclude',
            'label'     => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.file_primary_xpath',
            'config'    => array(
                'type' => 'input',
                'size' => 80,
                'eval' => 'trim',
        ...
        'active_messaging_document_deleted_url' => array(
            'exclude' => 1,
            'label'   => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.active_messaging_document_deleted_url',
            'config'  => array(
                'type' => 'input',
                'size' => 50,
                'eval' => 'trim',
        ...
        'active_messaging_document_deleted_url_body' => array(
            'exclude' => 1,
            'label'   => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.active_messaging_document_deleted_url_body',
            'config'  => array(
                'type' => 'text',
                'cols' => 40,
                'rows' => 15,
        ...
        'project_id_xpath' => array(
            'exclude'   => 1,
            'l10n_mode' => 'exclude',
            'label'     => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.search_field_xml.project_id.xpath',
            'config'    => array(
                'type' => 'input',
                'size' => 80,
                'eval' => 'trim',
        ...
        'project_title_xpath' => array(
            'exclude'   => 1,
            'l10n_mode' => 'exclude',
            'label'     => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.search_field_xml.project_title.xpath',
            'config'    => array(
                'type' => 'input',
                'size' => 80,
                'eval' => 'trim',
        ...
        'search_language_xpaths' => array(
            'exclude'   => 1,
            'l10n_mode' => 'exclude',
            'label'     => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.search_field_xml.search_language.xpath',
            'config'    => array(
                'type' => 'text',
                'cols' => 80,
                'rows' => 10,
        ...
        'search_corporation_xpaths' => array(
            'exclude'   => 1,
            'l10n_mode' => 'exclude',
            'label'     => 'LLL:EXT:dpf/Resources/Private/Language/locallang_db.xlf:tx_dpf_domain_model_client.search_field_xml.search_corporation.xpath',
            'config'    => array(
                'type' => 'text',
                'cols' => 80,
                'rows' => 10,
